...
export const DASHBOARDMENU_PATHS = {
  1: "/dashboard/home",
  13: "/dashboard/LandAcquisition",
  14: "/dashboard/SJYGandhiDashboard",
};

export default function ProtectedRoute({ children, menuId, roleAccess }) {
  const hasAccess = roleAccess?.some((item) => item.MenuId === menuId);
      ...
      <>
        ...
        >
          ...
          >
            ...
            <Typography mt={3} sx={{ fontSize: "32px", opacity: 0.8 }}>
              🔒🔐🚷
            </Typography>
          </Card>
        </Box>
